...
public class SigninStopcut  extends AsyncTask<String,Void,String>
{    
	
    
    public SigninStopcut(OnClickListener onClickListener) 
        {
    ...
    protected String doInBackground(String... arg0) 
    {
        try
            {                 
                String link="http://192.168.0.2:8080/stopcut.php";                
