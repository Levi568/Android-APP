...
public class SigninStop  extends AsyncTask<String,Void,String>
{    
	
   
    public SigninStop(OnClickListener onClickListener) 
        {
    ...
    protected String doInBackground(String... arg0) 
    {
        try
            {                 
                String link="http://192.168.0.2:8080/stop.php";                
