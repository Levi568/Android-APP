...
public class SigninStopsensor  extends AsyncTask<String,Void,String>
{    	
    private Context context;
    public SigninStopsensor(Context context) 
        {
    ...
    protected String doInBackground(String... arg0) 
    {
        try
            {                 
                String link="http://192.168.0.2:8080/forward.php";                
